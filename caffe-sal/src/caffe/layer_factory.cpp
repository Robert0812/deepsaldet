...
Layer<Dtype>* GetLayer(const LayerParameter& param) {
  ...
  case LayerParameter_LayerType_MCWINDOW_DATA:
    return new MCWindowDataLayer<Dtype>(param);
  case LayerParameter_LayerType_NAMCWINDOW_DATA:
    return new NAMCWindowDataLayer<Dtype>(param);
